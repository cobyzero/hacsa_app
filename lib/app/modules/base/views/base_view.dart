...
import 'package:badges/badges.dart' as rp;
      ...
      builder: (_) => Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            _mBottomNavItem(label: 'category', icon: Constants.categoryIcon),
            const BottomNavigationBarItem(label: '', icon: Center()),
            _mBottomNavItem(label: 'Calendar', icon: Constants.calendarIcon),
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: GetBuilder<BaseController>(
            id: 'CartBadge',
            builder: (_) => rp.Badge(
              position: rp.BadgePosition.bottomEnd(bottom: -16, end: 13),
              badgeContent: Text(
